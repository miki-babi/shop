                            ...
                            @foreach ($orders as $order)
                                <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                                    ...
                                    <td class="py-3 px-6 flex gap-2">
                                        <a href="{{ route('detail', ['id' => $order->id]) }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-3 rounded shadow">Print</a>
                                        <form action="{{ route('handover', ['id' => $order->id]) }}" method="POST" onsubmit="return ajaxHandover(event, this, {{ $order->id }})">
                                            @csrf
