                    ...
                    @foreach ($orders as $order)
                        <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 px-6 flex gap-2">
                                <button onclick="printOrder({{ $order->id }})" class="bg-green-500 hover:bg-green-600 text-white font-bold py-1 px-3 rounded shadow focus:outline-none focus:ring-2 focus:ring-green-400">Print</button>
